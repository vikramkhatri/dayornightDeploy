    ...
    if ( $(this).data('recaptcha-site-key') ) {
      ...
      grecaptcha.ready(function() {
        grecaptcha.execute(recaptcha_site_key, {action: 'email_form_submit'}).then(function(token) {
          email_form_submit(this_form,action,this_form.serialize() + '&recaptchaResponse=' +  token);
        });
      });
    } else {
  ...
  function email_form_submit(this_form, action, data) {
    $.ajax({
      ...
      if (typeof obj === "object") {
        ...
        console.log("obj.statusText=" + obj.statusText);
        if (obj.status === true) {
          this_form.find('.loading').slideUp();
          ...
          if(!obj) {
            ...
            msg = "Form submission failed" + obj.statusText;
          }
